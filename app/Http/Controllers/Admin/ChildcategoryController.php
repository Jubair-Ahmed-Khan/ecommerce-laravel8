...
class ChildcategoryController extends Controller
{
    ...
    // all childcategory showing method 
    ...
    //all childcategory insert method
    public function store(Request $request){
        ...
        $saved = DB::table('childcategories')->insert($data);

        if($saved){
            $notification = array('message' => 'Childcateogry inserted', 'alert-type' => 'success');
            return redirect()->back()->with($notification);
        }

    }

    //all childcategory edit method
    ...
    public function update(Request $request){
        ...
        $updated = DB::table('childcategories')->where('id',$request->id)->update($data);

        if($updated){
            $notification = array('message' => 'Childcateogry updated', 'alert-type' => 'success');
            return redirect()->back()->with($notification);
        }
    }

    public function delete($id){
        $deleted = DB::table('childcategories')->where('id',$id)->delete();

        if($deleted){
            $notification = array('message' => 'childcateogry deleted', 'alert-type' => 'success');
            return redirect()->back()->with($notification);
        }
    }
}
