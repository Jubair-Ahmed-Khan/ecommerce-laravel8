    ...
    <div class="card-body">
      ...
      <form action="{{route('login')}}" method="post">
        ...
        <div class="input-group mb-1">
          <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="enter password" value="{{ old('password') }}"required autocomplete="password">
          <div class="input-group-append">
            <div class="input-group-text">
