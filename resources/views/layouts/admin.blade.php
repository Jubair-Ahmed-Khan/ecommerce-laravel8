      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel pb-3 mb-3 d-flex">
            <div class="image">
              <img src="https://png.pngtree.com/png-vector/20190710/ourmid/pngtree-user-vector-avatar-png-image_1541962.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
  ...
  <script>
    $(document).on("click", "#delete", function(e) {
      ...
      Swal.fire({
          ...
          text:'Once Delete, This wll be Permanentlty Deleted',
          icon: "warning",
          buttons: true,
          dangerMode: true
        })
